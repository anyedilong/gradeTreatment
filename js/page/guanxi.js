// 跳转关系页面
function jumpGuanxi(hospitalId, page) {
    var tabSrc = parent.tabSrc;
    var menusrc = 'referralRelationship.html';
    ...
    window.location.href = 'referralRelationship.html?hospitalId=' + hospitalId + '&page=' + page;
    return false;
}
// 菜单变化
function menuWid () {
